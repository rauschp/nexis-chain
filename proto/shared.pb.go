...
func (x *EmptyAckResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmptyAckResponse) ProtoMessage() {}

func (x *EmptyAckResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_shared_proto_msgTypes[0]
...
// Deprecated: Use EmptyAckResponse.ProtoReflect.Descriptor instead.
...
var file_proto_shared_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x12, 0x0a, 0x10, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x41, 0x63, 0x6b,
...
var file_proto_shared_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_shared_proto_goTypes = []interface{}{
	(*EmptyAckResponse)(nil), // 0: EmptyAckResponse
}
