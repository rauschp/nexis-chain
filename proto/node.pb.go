...
func (x *InitMessage) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *InitMessage) GetHeight() int32 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *InitMessage) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *InitMessage) GetNodeHosts() []string {
	if x != nil {
		return x.NodeHosts
	}
	return nil
...
func (x *InitMessage) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_proto_node_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x12, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64,
	...
	0x91, 0x01, 0x0a, 0x0b, 0x49, 0x6e, 0x69, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	0x6f, 0x64, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09,
	0x6e, 0x6f, 0x64, 0x65, 0x48, 0x6f, 0x73, 0x74, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x32, 0x71, 0x0a, 0x0b, 0x4e, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x2a, 0x0a, 0x0a, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65,
	0x12, 0x0c, 0x2e, 0x49, 0x6e, 0x69, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x0c,
	0x2e, 0x49, 0x6e, 0x69, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x12, 0x36,
	...
	0x6e, 0x1a, 0x11, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x41, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70,
...
var file_proto_node_proto_goTypes = []interface{}{
	(*InitMessage)(nil),      // 0: InitMessage
	(*Transaction)(nil),      // 1: Transaction
	(*EmptyAckResponse)(nil), // 2: EmptyAckResponse
}
var file_proto_node_proto_depIdxs = []int32{
	0, // 0: NodeService.Initialize:input_type -> InitMessage
	1, // 1: NodeService.HandleTransaction:input_type -> Transaction
	0, // 2: NodeService.Initialize:output_type -> InitMessage
	2, // 3: NodeService.HandleTransaction:output_type -> EmptyAckResponse
